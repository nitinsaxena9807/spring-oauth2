...
public class EmailVerificationListener implements ApplicationListener<UserRegistrationEvent> {
	...
	public void onApplicationEvent(UserRegistrationEvent event) {
		...
		message.setSubject("Nitin's Spring Oauth2 API Testing Verification");
		message.setText("Account activation link for Spring Login Api Testing: https://localhost:8443/myapp/verify/email?id="+verificationId);
		message.setTo(email);
